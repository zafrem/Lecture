...
### 01. [Data Collector](01_Data_collector/README.md)
Practical scripts for gathering and processing real-world data from various sources.
*   **Financial Data**: Fetch stock market data using `yfinance` and cryptocurrency stats via `binance`.
*   **Trend Analysis**: Track keywords using Google Trends and Blackkiwi.
...
### 04. [Office Automation](04_Office_Automation/)
Scripts designed to automate repetitive administrative and operational tasks.
*   **Task Management**: Control and search Jira issues programmatically (`Jira_control_information.py`).
*   **Communication**: Automate email dispatching via Gmail and Office365 (`SMTP_gmail.py`).
*   **Scheduling**: Manage conference and event details (`Conference_control.py`).
*   **Security Ops**: Retrieve secrets from Hashicorp Vault.

### 08. [Cybersecurity and Vulnerability Analysis](08_Cybersecurity/README.md)
Explore security concepts and build custom Python tools for defense and analysis.
*   **Network Security**: Build your own subnet scanner (`subnet_scanner.py`).
*   **Log Analysis**: Tools for visualizing log frequency and extracting error patterns (`log_frequency_analyzer.py`, `error_pattern_extractor.py`).
*   **Core Concepts**: Implement basic authentication, encryption, and vulnerability assessment scripts.
